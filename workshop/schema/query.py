...
class Query(graphene.ObjectType):
    ...
    client = graphene.List(ClientType)
    hardware = graphene.List(HardwareType)
    entry = graphene.List(EntryType)
    service = graphene.List(ServiceType)
    piece = graphene.List(PieceType)
    otherpiece = graphene.List(OtherPieceType)
    fix = graphene.List(FixType)
    roadentry = graphene.List(RoadEntryType)
    subroadservice = graphene.List(SubRoadServiceType)
    roadservice = graphene.List(RoadServiceType)
    log = graphene.List(LogType)
